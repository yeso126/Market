...
.factory('chartDataService', function ($q, encodeURIService, $http, chartDataCacheService){
...
.factory('fillMyStockCacheService', function (CacheFactory) {
...
.factory('myStocksArrayService',function(fillMyStockCacheService, myStocksCacheService){

  if(!myStocksCacheService.info('myStocks')) {
    fillMyStockCacheService.fillMyStocksCache();
  }
